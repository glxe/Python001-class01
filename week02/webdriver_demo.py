...
#     browser.find_element_by_xpath('//*[@id="username"]').send_keys('15688888888')
#     browser.find_element_by_xpath('//*[@id="password"]').send_keys('sfs')
#     time.sleep(1)
...
try:
    ...
    browser.get('https://www.baacloud44.com/')
    time.sleep(2)
    browser.find_element_by_xpath('//ul[@class="nav navbar-nav navbar-right"]/li[@class="signin"]/a[@data-target="#log_part"]').click()
    time.sleep(3)
    browser.find_element_by_xpath('//div[@class="modal-body"]//input[@name="email"]').send_keys('15888888888')
    browser.find_element_by_xpath('//div[@class="modal-body"]//input[@name="passwd"]').send_keys('sdfs')
    time.sleep(2)
    loginBtn = browser.find_element_by_xpath('//div[@class="modal-body"]//input[@name="Submit"]')
    loginBtn.click()
